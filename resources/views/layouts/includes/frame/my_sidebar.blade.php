				...
				<div class="">
					@auth	{{-- Si esta Logueado Mostramos su foto de Perfil y Datos --}}
						<div class="main-menu-header">
							<img class="img-radius" src="{{ asset('images/user/'.Auth::user()->image) }}" alt="User-Profile-Image">
						...
						<div class="collapse" id="nav-user-link">
							<ul class="list-unstyled">
								...
								<li class="list-group-item"><a href="javascript:void(0)" onclick="event.preventDefault(); document.getElementById('logout-form2').submit();"><i class="feather icon-log-out m-r-5"></i>Logout</a></li>
							</ul>
						</div>
					@endauth
